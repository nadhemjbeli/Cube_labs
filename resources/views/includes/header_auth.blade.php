...
padding-bottom: 10px;" id="app1">
    ...
    <a class="navbar-brand active table-bordered rounded-pill" href="{{route('dashboard') }}" aria-disabled="true">E- <span
            class="font-weight-bold" style="color: tomato">Work</span></a>

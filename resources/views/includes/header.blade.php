<nav class="navbar navbar-expand-sm navbar-dark bg-dark " style="margin-bottom: 0" id="app1">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav mr-auto">
            <ul class=" navbar-nav">
                ...
                <li class="{{ Request::segment(1) === 'signupPage' ? 'active' : null }}"><a
                        class="nav-link text-uppercase" href="{{route('signupPage') }}">sign up</a></li>
                ...
                <li class="{{ Request::segment(1) === 'properties' ? 'active' : null }}"><a
                        class="nav-link text-uppercase" href="{{route('properties') }}">properties</a></li>
